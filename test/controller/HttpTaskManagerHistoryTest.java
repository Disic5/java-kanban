...
public class HttpTaskManagerHistoryTest {
    ...
    @DisplayName("Показать историю задач")
    @Test
    public void testGetHistory() throws IOException, InterruptedException {
        ...
        assertEquals("Test 1", history.get(0).getName(), "Некорректное имя задачи");
        assertEquals("Test 2", history.get(1).getName(), "Некорректное имя задачи");
        assertEquals("Test 3", history.get(2).getName(), "Некорректное имя задачи");
    }
