...
//        System.out.println(taskManager.getAllSubtaskByEpic(epic1.getId()));
//        System.out.println(taskManager.getAllSubtaskByEpic(epic2.getId()));
//        System.out.println(taskManager.getAllSubtaskByEpic(epic3.getId()));
...
//        System.out.println("GET HISTORY \n" + Managers.getDefaultHistory().getHistory() + "-".repeat(50));
